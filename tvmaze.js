...
var $searchFormTerm = $("#searchForm-term");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    resp = _a.sent();
                    arrayOfEps = resp.data;
                    console.log(arrayOfEps);
                    return [2 /*return*/, arrayOfEps];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    show = evt.target.parentElement.parentElement.parentElement;
                    showId = show.getAttribute("data-show-id");
                    return [4 /*yield*/, getEpisodesOfShow(parseInt(showId))];
                case 1:
                    eps = _a.sent();
